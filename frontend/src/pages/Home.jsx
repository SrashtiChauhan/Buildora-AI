        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20">
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur hover:border-indigo-400 transition">
            ...
            <p className="text-sm text-gray-400">
              Describe your idea and get a complete website instantly - no setup, no delay.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur hover:border-indigo-400 transition">
            ...
            <p className="text-sm text-gray-400">
              Every layout adapts seamlessly across devices with clean, modern structure.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur hover:border-indigo-400 transition">
            ...
            <p className="text-sm text-gray-400">
              Download clean, production-ready code and use it anywhere you want.
            </p>
          </div>
